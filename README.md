...
BPM ค่า จังหวะดนตรีของ melody ว่า  
หากเป็นโน้ตตัวดำ (Quarter Note) จะมีกี่ Beat (ครั้ง) ต่อนาที  
  
- หาก BPM มีค่ามาก โน้ตแต่ละตัว ใน melody จะมีจังหวะที่สั้นลง เพลงจะเล่นเร็วขึ้น  
- หาก BPM มีค่าน้อย โน้ตแต่ละตัว ใน melody จะมีจังหวะที่ยาวขึ้น เพลงจะเล่นยืดเวลานานขึ้น  

**ตัวอย่าง** หาก BPM=60 แสดงว่า melody นี้  
